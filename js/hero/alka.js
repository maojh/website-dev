...
function draw(){
  ...
  fill(255);
  //text(retiniRandom +"."+nbr_circles+"."+spaziatura+"."+spessoreLinea+"."+poligono, mouseX, mouseY);
  text(retiniRandom, mouseX, mouseY);
...
function cerchio_05(){
    ...
    for (var i = 1; i <= nbr_circles; ++i) {
      ...
      stroke(chiaro);
      strokeWeight(spessoreLinea*i);
      noFill();
      polygon(cx, cy, spaziatura*i, poligono);
    }
}
function cerchio_06(){
    var lg_circ = PI * lg_diam;
...
function sliders(){
  retiniRandomSlider = createSlider(2, 7);
